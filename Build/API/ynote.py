...
def showProjectView(fileName=None):
	if fileName == None:
		folderDlg = System.Windows.Forms.FolderBrowserDialog()
		folderDlg.ShowDialog()
		if folderDlg.SelectedPath != "":
			ynote.ShowProjectView(folderDlg.SelectedPath)
	else:
		ynote.ShowProjectView(fileName)
